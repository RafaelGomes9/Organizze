      ...
      //  String mes = retornoData[1];
        ...
        if(!textoValor.isEmpty() && textoValor.contains("1") | textoValor.contains("2") | textoValor.contains("3") | textoValor.contains("4") | textoValor.contains("5") | textoValor.contains("6") | textoValor.contains("7") | textoValor.contains("8") | textoValor.contains("9") | textoValor.contains("0"))
        {
            ...
            if(verificarData)
            {
                ...
                if(!textoCategoria.isEmpty())
                {
                    ...
                    if (!textoDescricao.isEmpty())
                    {
                        ...
                        if (networkInfo != null && networkInfo.isConnectedOrConnecting())
                        {
                            ...
                            Toast.makeText(ReceitasActivity.this, "Ocorreu um erro ao salvar a receita. Verifique a conexão com a internet", Toast.LENGTH_SHORT).show();
                            return false;
                ...
                Toast.makeText(ReceitasActivity.this,"A Data não foi preenchida corretamente!",Toast.LENGTH_SHORT).show();
                return false;
